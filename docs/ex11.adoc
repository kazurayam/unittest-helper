...
The link:https://github.com/kazurayam/unittest-helper/blob/develop/app/src/test/java/io/github/someone/somestuff/SampleTest.java[io.github.someone.examples.SampleTest] class has one more test method:

[source]
----
include::../app/src/test/java/io/github/someone/examples/SampleTest.java[lines=50..60]
----
