...
[source, java]
----
include::../app/src/test/java/com/kazurayam/unittesthelperdemo/Ex04Test.java[]
----
link:https://github.com/kazurayam/unittest-helper/blob/develop/app/src/test/java/com/kazurayam/unittesthelperdemo/Ex04Test.java[source]
